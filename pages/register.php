...
<head>
    ...
    <title>REGISTERE PAGE | Zemon Hub</title>
...
<body>
    ...
    <div class="w-full h-screen bg-gradient-to-r from-cyan-500 to-blue-700 flex justify-item-center content-center">
        <div class="bg-neutral-800 h-96 w-2/6 m-auto rounded-lg shadow-md">
            <div class="w-full text-center h-full flex justify-item-center content-center">
                <!--Form-Input-->
                <form action="../services/singUp_db.php" method="post" class="w-3/4 m-auto">
                    <div class="text-white text-2xl font-bold mb-4">RegisterPage</div>
                    <!--Username-Input-->
                    ...
                    <!--Email-Input-->
                    <div class="flex content-center px-4 mb-4">
                        <div class="rounded-l-lg bg-gray-400 w-8"><i class="fa-solid fa-envelope mt-2 text-white"></i></div>
                        <input type="text" class="w-full h-8 p-1 rounded-r-lg" placeholder="Email Address" name="email"/>
                    </div>
                    <!--Password-Input-->
                    <div class="flex content-center px-4 mb-4">
                    ...
                    <div class="flex content-center px-4 mb-4">
                        <div class="rounded-l-lg bg-gray-400 w-8"><i class="fa-solid fa-key mt-2 text-white"></i></div>
                        <input type="password" class="w-full h-8 p-1 rounded-r-lg focus:ring-2" placeholder="Confirm Password" name="cfpassword"/>
                    </div>
                    <!--Submit-Form-->
                    <div class="px-4">
